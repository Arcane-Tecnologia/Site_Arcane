        ...
        <div className="container relative z-10 mx-auto px-6 pb-16 lg:px-12 lg:pb-24">
          ...
          <div className="mt-10 grid gap-10 lg:grid-cols-[1fr_1fr] lg:items-center">
            <div className="order-2 lg:order-1">
              ...
              <p className="mt-5 max-w-2xl font-inter text-sm leading-relaxed text-slate-200 lg:text-base">
              ...
              <p className="mt-4 max-w-2xl font-inter text-sm leading-relaxed text-slate-300/80">
      ...
      <section id="visao-geral" className="section-shell py-16 lg:py-24">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-5 font-cormorant text-[2.2rem] leading-tight text-slate-950 lg:text-[3rem]">
              Do WhatsApp ao CRM: um fluxo comercial estruturado.
            </h2>
            <p className="mt-5 font-inter text-sm leading-relaxed text-slate-700 lg:text-[15px]">
            ...
            <p className="mt-4 font-inter text-sm leading-relaxed text-slate-700 lg:text-[15px]">
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-3">
            {overviewCards.map((card) => (
              <div key={card.title} className="panel-shell rounded-[1.8rem] p-6 lg:p-7">
                ...
                <h3 className="mt-5 font-cormorant text-[1.6rem] text-slate-950">{card.title}</h3>
                <p className="mt-3 font-inter text-sm leading-relaxed text-slate-700">{card.text}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="section-shell-alt py-16 lg:py-24">
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="mt-10 rounded-[2rem] border border-brand-cyan/20 bg-brand-cyan/8 p-6 lg:p-8">
            <p className="font-cormorant text-[1.6rem] leading-tight text-slate-950 lg:text-[2rem]">
              Receber mensagens não significa ter um processo comercial organizado.
            </p>
          </div>
        </div>
              ...
              {flowSteps.map((step, index) => (
                <div key={step.label} className="flex items-center gap-2 lg:gap-3">
                  <div className="flex items-center gap-2 rounded-full border border-brand-cyan/20 bg-white/80 px-4 py-2.5 shadow-sm backdrop-blur-md">
                    ...
                    <span className="font-inter text-[11px] uppercase tracking-[0.12em] text-slate-800">
                      {step.label}
                    </span>
                  </div>
          ...
          <div className="mt-10 grid gap-4 md:grid-cols-2">
            {stackCards.map((card) => (
              <div key={card.title} className="panel-shell rounded-[1.8rem] p-6 lg:p-8">
                <h3 className="font-cormorant text-[1.8rem] text-slate-950">{card.title}</h3>
                <p className="mt-3 font-inter text-sm leading-relaxed text-slate-700">{card.text}</p>
              </div>
            ))}
          </div>
          ...
          <div className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {functionalities.map((item) => (
              ...
              >
                ...
                <p className="font-inter text-sm leading-relaxed text-slate-700">{item}</p>
              </div>
            ))}
          </div>
        </div>
            ...
            <div className="space-y-3">
              {aiRoles.map((role) => (
                ...
                >
                  ...
                  <p className="font-inter text-sm leading-relaxed text-slate-700">{role}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {benefits.map((benefit) => (
              <div key={benefit.title} className="panel-shell rounded-[1.8rem] p-6 lg:p-7">
                ...
                <h3 className="mt-5 font-cormorant text-[1.5rem] text-slate-950">{benefit.title}</h3>
                <p className="mt-3 font-inter text-sm leading-relaxed text-slate-700">{benefit.text}</p>
              </div>
            ))}
          </div>
        </div>
            ...
            <div className="space-y-3">
              {localAiBenefits.map((benefit) => (
                ...
                >
                  ...
                  <p className="font-inter text-sm leading-relaxed text-slate-700">{benefit}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="section-shell py-16 lg:py-24">
        <div className="container mx-auto px-6 lg:px-12">
              ...
              {architectureSteps.map((step, index) => (
                <div key={step} className="flex flex-col items-center">
                  <div className="w-full rounded-[1.2rem] border border-white/60 bg-white/70 px-5 py-3 text-center shadow-sm backdrop-blur-md">
                    <span className="font-inter text-sm font-medium text-slate-800">{step}</span>
                  </div>
          ...
          <div className="mt-12 max-w-3xl">
            <p className="font-inter text-sm leading-relaxed text-slate-700 lg:text-[15px]">
          ...
          <div className="mt-10 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {useCases.map((useCase) => (
              ...
              >
                ...
                <p className="font-inter text-sm leading-relaxed text-slate-700">{useCase.label}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="mt-10 grid gap-3 sm:grid-cols-2">
            {expectedResults.map((result) => (
              ...
              >
                <span className="mt-2 h-2.5 w-2.5 shrink-0 rounded-full bg-brand-cyan-strong" />
                <p className="font-inter text-sm leading-relaxed text-slate-700">{result}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="section-shell-dark premium-grid py-16 lg:py-24">
        ...
        <div className="container relative z-10 mx-auto px-6 lg:px-12">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 font-inter text-sm leading-relaxed text-slate-200 lg:text-base">
